...
fn setup_adc() {
    cortex_m::interrupt::free(|cs| {
        ...
        voltage_sampler
            .smpr2
            .modify(|_, w| unsafe { w.smp6().bits(111) });
